    ...
    companion object{
        ...
        fun getRoomConnectionIntent(
            ...
            val videoCallEnabled = sharedPrefGetBoolean(
                ...
                EXTRA_VIDEO_CALL, R.string.pref_videocall_default, useValuesFromIntent, context, sharedPref
            )
            ...
            val videoCodec = sharedPrefGetString(
                ...
                EXTRA_VIDEOCODEC, R.string.pref_videocodec_default, useValuesFromIntent, context, sharedPref
            )
            val audioCodec = sharedPrefGetString(
                R.string.pref_audiocodec_key,
                EXTRA_AUDIOCODEC, R.string.pref_audiocodec_default, useValuesFromIntent, context, sharedPref
            )

            // Check HW codec flag.
            val hwCodec = sharedPrefGetBoolean(
                R.string.pref_hwcodec_key,
                EXTRA_HWCODEC_ENABLED, R.string.pref_hwcodec_default, useValuesFromIntent, context, sharedPref
            )
            ...
            val flexfecEnabled = sharedPrefGetBoolean(
                ...
                EXTRA_FLEXFEC_ENABLED, R.string.pref_flexfec_default, useValuesFromIntent, context, sharedPref
            )
            ...
            val aecDump = sharedPrefGetBoolean(
                ...
                EXTRA_AECDUMP_ENABLED, R.string.pref_aecdump_default, useValuesFromIntent, context, sharedPref
            )

            // Check OpenSL ES enabled flag.
            val useOpenSLES = sharedPrefGetBoolean(
                R.string.pref_opensles_key,
                EXTRA_OPENSLES_ENABLED, R.string.pref_opensles_default, useValuesFromIntent, context, sharedPref
            )
            ...
            val captureQualitySlider = sharedPrefGetBoolean(
                ...
                R.string.pref_capturequalityslider_default, useValuesFromIntent, context, sharedPref
            )
            ...
            val displayHud = sharedPrefGetBoolean(
                ...
                EXTRA_DISPLAY_HUD, R.string.pref_displayhud_default, useValuesFromIntent, context, sharedPref
            )
            ...
            val negotiated = sharedPrefGetBoolean(
                ...
                EXTRA_NEGOTIATED, R.string.pref_negotiated_default, useValuesFromIntent, context, sharedPref
            )
            ...
            val protocol = sharedPrefGetString(
                ...
                EXTRA_PROTOCOL, R.string.pref_data_protocol_default, useValuesFromIntent, context, sharedPref
            )
